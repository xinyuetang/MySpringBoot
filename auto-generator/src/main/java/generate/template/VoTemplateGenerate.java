...
public class VoTemplateGenerate {

    private static final String modelTemplate = "Vo.ftl";
    ...
    public VoTemplateGenerate(ClassInfo classInfo, MetaDataInfo metaDataInfo) {
    ...
    public void generate() throws IOException, TemplateException {
        ...
        Writer out = null;
        try {
            String modelName = classInfo.getClassSimpleName() + "Vo.java";
            Template template = FreeMarkerTemplate.getTemplate(modelTemplate);
            File dir = new File(classInfo.getSaveDirPath(), "/vo");
            if (!dir.exists()) {
                if (!dir.mkdirs()){
            ...
            System.out.println("Vo File:" + modelFile.getAbsoluteFile());

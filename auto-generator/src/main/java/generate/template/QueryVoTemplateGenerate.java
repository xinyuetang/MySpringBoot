...
public class QueryVoTemplateGenerate {
    ...
    public QueryVoTemplateGenerate(ClassInfo classInfo, MetaDataInfo metaDataInfo) {
    ...
    public void generate() throws IOException, TemplateException {
        ...
        try {
            String query = classInfo.getClassSimpleName() + classInfo.getQuerySuffix() + "Vo.java";
            Template template = FreeMarkerTemplate.getTemplate("QueryVo.ftl");

            File queryDir = new File(classInfo.getSaveDirPath(), "vo");
            if (!queryDir.exists()) {
                if (!queryDir.mkdirs()) {
            ...
            System.out.println("QueryVo File:" + queryFile.getAbsoluteFile());

...
public class MapperTemplateGenerate {
    ...
    private static final String daoTemplate = "Mapper.ftl";

    private ClassInfo classInfo;

    private MetaDataInfo metaDataInfo;

    public MapperTemplateGenerate(ClassInfo classInfo, MetaDataInfo metaDataInfo) {
    ...
    public void generate() throws IOException, TemplateException {
        ...
        Writer out = null;
        try {
            String daoName = classInfo.getClassSimpleName() + "Mapper.java";
            Template template = FreeMarkerTemplate.getTemplate(daoTemplate);
            File dir = new File(classInfo.getSaveDirPath(), "/mapper");
            if (!dir.exists()) {
                if (!dir.mkdirs()) {
            ...
            System.out.println("MapperFile:" + daoFile.getAbsoluteFile());

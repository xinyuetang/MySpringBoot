...
public class TestTemplateGenerate {

    private static final String daoTemplate = "Test.ftl";
    ...
    public TestTemplateGenerate(ClassInfo classInfo, MetaDataInfo metaDataInfo) {
    ...
    public void generate() throws IOException, TemplateException {
        ...
        Writer out = null;
        try {
            String daoName = classInfo.getClassSimpleName() + "Test.java";
            Template template = FreeMarkerTemplate.getTemplate(daoTemplate);
            File dir = new File(classInfo.getSaveDirPath(), "/test");
            if (!dir.exists()) {
                if (!dir.mkdirs()){
            ...
            System.out.println("TestFile:" + daoFile.getAbsoluteFile());

...
public class EntityTemplateGenerate {

    private static final String modelTemplate = "Entity.ftl";
    ...
    public EntityTemplateGenerate(ClassInfo classInfo, MetaDataInfo metaDataInfo) {
    ...
    public void generate() throws IOException, TemplateException {
        ...
        Writer out = null;
        try {
            String modelName = classInfo.getClassSimpleName() + ".java";
            Template template = FreeMarkerTemplate.getTemplate(modelTemplate);
            File dir = new File(classInfo.getSaveDirPath(), "/entity/");
            if (!dir.exists()) {
                if (!dir.mkdirs()) {
            ...
            System.out.println("EntityFile:" + modelFile.getAbsoluteFile());

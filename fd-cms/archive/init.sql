...
VALUES ('07175', '杨珉', 10, CURRENT_TIMESTAMP),
       ('35004', '杨哲慜', 10, CURRENT_TIMESTAMP),
       ('34083', '张源', 10, CURRENT_TIMESTAMP),
       ('04278', '朱东来', 10, CURRENT_TIMESTAMP),
       ('04795', '张谧', 10, CURRENT_TIMESTAMP),
       ('41274', '张磊', 10, CURRENT_TIMESTAMP),
       ('BH6114', '张晓寒', 10, CURRENT_TIMESTAMP),
       ('19110240038', '游小钰', 0, CURRENT_TIMESTAMP),
       ('20110240040', '戴嘉润', 0, CURRENT_TIMESTAMP),
       ('20110240046', '廉轲轲', 0, CURRENT_TIMESTAMP),
       ('20110240048', '谈心', 0, CURRENT_TIMESTAMP),
       ('20110240049', '肖浩宇', 0, CURRENT_TIMESTAMP),
       ('17302010026', '邓朋', 0, CURRENT_TIMESTAMP),
       ('17212010064', '刘昕伟', 0, CURRENT_TIMESTAMP),
       ('14110240013', '张季博宁', 0, CURRENT_TIMESTAMP),
       ('17212010067', '乔颖', 0, CURRENT_TIMESTAMP),
       ('18210240204', '魏诗萌', 0, CURRENT_TIMESTAMP),
       ('18212010007', '贺瑞', 0, CURRENT_TIMESTAMP),
       ('18212010023', '乔丹', 0, CURRENT_TIMESTAMP),
       ('18212010031', '王寒蕊', 0, CURRENT_TIMESTAMP),
       ('18212010040', '武多才', 0, CURRENT_TIMESTAMP),
       ('18212010044', '许朝智', 0, CURRENT_TIMESTAMP),
       ('18212010069', '邵凯强', 0, CURRENT_TIMESTAMP),
       ('18212010076', '许海龙', 0, CURRENT_TIMESTAMP),
       ('18212010079', '张怀恩', 0, CURRENT_TIMESTAMP),
       ('19210240040', '刘安聪', 0, CURRENT_TIMESTAMP),
       ('19210240042', '张智搏', 0, CURRENT_TIMESTAMP),
       ('19210240047', '施游堃', 0, CURRENT_TIMESTAMP),
       ('19210240049', '杨森', 0, CURRENT_TIMESTAMP),
       ('19210240051', '汪海沛', 0, CURRENT_TIMESTAMP),
       ('19210240054', '花楠', 0, CURRENT_TIMESTAMP),
       ('19210240059', '钟明', 0, CURRENT_TIMESTAMP),
       ('19210240146', '朱家明', 0, CURRENT_TIMESTAMP),
       ('19210240158', '杨悉瑜', 0, CURRENT_TIMESTAMP),
       ('19210240159', '林奕帆', 0, CURRENT_TIMESTAMP),
       ('19210240180', '王子雯', 0, CURRENT_TIMESTAMP),
       ('19210240213', '邓瑞祺', 0, CURRENT_TIMESTAMP),
       ('19212010062', '张卓', 0, CURRENT_TIMESTAMP),
       ('20210240039', '刘壮', 0, CURRENT_TIMESTAMP),
       ('20210240041', '叶瀚', 0, CURRENT_TIMESTAMP),
       ('20210240046', '曹家俊', 0, CURRENT_TIMESTAMP),
       ('20210240052', '盛钡娜', 0, CURRENT_TIMESTAMP),
       ('20210240056', '肖起凡', 0, CURRENT_TIMESTAMP),
       ('20210240058', '陈晓婷', 0, CURRENT_TIMESTAMP),
       ('20210240099', '卢苇', 0, CURRENT_TIMESTAMP),
       ('20210240108', '吕海铭', 0, CURRENT_TIMESTAMP),
       ('20210240111', '吴子成', 0, CURRENT_TIMESTAMP),
       ('20210240134', '孙心乾', 0, CURRENT_TIMESTAMP),
       ('20210240143', '宓晨远', 0, CURRENT_TIMESTAMP),
       ('20210240152', '张函歌', 0, CURRENT_TIMESTAMP),
       ('20210240155', '张嘉熙', 0, CURRENT_TIMESTAMP),
       ('20210240167', '张煜坤', 0, CURRENT_TIMESTAMP),
       ('20210240176', '徐梓航', 0, CURRENT_TIMESTAMP),
       ('20210240215', '李驰', 0, CURRENT_TIMESTAMP),
       ('20210240234', '毛硕', 0, CURRENT_TIMESTAMP),
       ('20210240238', '汪扬', 0, CURRENT_TIMESTAMP),
       ('20210240241', '洪文正', 0, CURRENT_TIMESTAMP),
       ('20210240280', '罗天涵', 0, CURRENT_TIMESTAMP),
       ('20210240329', '陈彦君', 0, CURRENT_TIMESTAMP),
       ('20210240353', '颜一帆', 0, CURRENT_TIMESTAMP),
       ('20212010021', '杜小林', 0, CURRENT_TIMESTAMP),
       ('20212010046', '龙京奇', 0, CURRENT_TIMESTAMP),
       ('20212010055', '叶浩祺', 0, CURRENT_TIMESTAMP),
       ('20212010088', '梁洁', 0, CURRENT_TIMESTAMP),
       ('20212010115', '袁明豪', 0, CURRENT_TIMESTAMP),
       ('20212010122', '赵钰迪', 0, CURRENT_TIMESTAMP);
